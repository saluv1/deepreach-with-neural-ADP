...
if (mode == 'all') or (mode == 'train'):
    ...
    p.add_argument('--num_epochs', type=int, default=2000, help='Number of epochs to train for.')
...
if (mode == 'all') or (mode == 'test'):
    experiment.test(
        ...
        set_type='BRT' if orig_opt.minWith in ['zero', 'target'] else 'BRS', control_type=opt.control_type, data_step=opt.data_step,gt_data_path=opt.gt_data_path)